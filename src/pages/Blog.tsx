...
const Blog = () => (
  <>
    <SEO
      title="Ideas, Historias y Conocimiento"
      description="Un espacio para explorar las últimas tendencias en tecnología, diseño de productos y estrategias de desarrollo."
      path="/blog"
    />
